...
def precompilado(cadena, mnemonicos_dir,mnemonicos_ext,mnemonicos_imm, mnemonicos_indx, mnemonicos_indy, mnemonicos_inh, mnemonicos_rel, stack_compiler_vls, stack_compiler_s19, stack_compiler_html,  stack_error,error_line, list_labels):
    ...
    if re.fullmatch(REL, cadena):
       ...
       # print(Matcher)
       compilado_REL(Matcher, mnemonicos_rel, stack_compiler_vls, stack_compiler_s19, stack_compiler_html,  stack_error,error_line, list_labels)

    elif re.fullmatch(INH, cadena):
        Matcher = re.split(INH, cadena)
        compilado_INH(Matcher, mnemonicos_inh, stack_compiler_vls, stack_compiler_s19, stack_compiler_html,  stack_error,error_line, list_labels)
        ...
        if re.fullmatch(GP1, Matcher[1]):
            ...
            if re.fullmatch(GP2, Matcher[2]):
                ...
                if re.fullmatch(GP3,  Matcher[3]):
                    #El operando existe
                    compilado_ALL5 (Matcher, mnemonicos_dir, mnemonicos_ext, mnemonicos_imm, mnemonicos_indx, mnemonicos_indy, stack_compiler_vls, stack_compiler_s19, stack_compiler_html,  stack_error,error_line, list_labels)
                    Matcher.clear
                else:
